    ...
    <main className="product-main">
      ...
      <div className="product-layout">
        ...
        <div className="product-info">
          <div>
            <h2 className="product-kicker">L'Essence de Velora</h2>
          ...
          {/* Volume */}
          <div className="product-option-block">
            <span className="product-option-title">Bottle Volume</span>
          ...
          <div className="product-cta">
            <button
              ...
              style={{
                background: "linear-gradient(to right, #6250ae, #c5b8ff)",
              }}
            >
              Add to Cart
            </button>
            <button className="cta-secondary">Buy Now</button>
          </div>
      ...
      <div className="product-tabs">
          ...
          {TABS.map((tab, i) => (
            <button
              ...
              style={{
                ...
                borderBottom:
                  activeTab === i ? "2px solid #6250ae" : "2px solid transparent",
              }}
            >
              {tab}
            </button>
        ...
        {activeTab === 0 && (
          <div className="tab-content">
            <p>
              Midnight Saffron represents the pinnacle of Velora's olfactory
